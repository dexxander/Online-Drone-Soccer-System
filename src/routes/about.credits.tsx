...
const DEVELOPERS: Array<{
...
}> = [
  {
    ...
    role: "Lead Developer",
    bio: "Led the development of this project, focusing on architecture and core features.",
  ...
  },
  {
    ...
    bio: "Designed the referee and scoreboard interfaces, ensuring a smooth user experience. Created the drone animations for the landing page.",
  ...
  },
  {
    ...
    role: "Frontend Developer",
    bio: "Designed the admin and coach interfaces, and implemented the frontend workflow logic for match management.",
    photo: "/team/job.jpg",
    ...
    <PublicLayout>
        ...
        <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-6 py-16 lg:grid-cols-2 lg:gap-14">
          ...
          <div>
            ...
            <p className="mt-5 text-[15px] leading-relaxed text-muted-foreground">
              AW Drone Soccer Leagues System is built by three students who spent match days
              watching coaches juggle spreadsheets and referees call scores across a noisy arena.
              That firsthand experience shaped a platform where coaches register their teams and
              rosters, admins approve entries and build tournament brackets, referees run the
              clock and score from pitchside, and every call reaches the live scoreboard the
              moment it happens. Each teammate owns a different part of the system, and together
              they test and refine it before every tournament.
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-xl border border-border bg-background shadow-card">
            {GROUP_PHOTO ? (
              <img src={GROUP_PHOTO} alt="The team" className="aspect-[4/3] w-full object-cover sm:aspect-video" />
            ) : (
              <div className="flex aspect-[4/3] w-full flex-col items-center justify-center gap-3 border-2 border-dashed border-border bg-muted text-muted-foreground sm:aspect-video">
                <Camera className="size-8" />
                <p className="text-sm font-semibold">Group photo placeholder</p>
                <p className="max-w-xs text-center text-xs">
                  Add the real photo to /public/team/group-photo.jpg and set GROUP_PHOTO in about.credits.tsx
                </p>
              </div>
            )}
          </div>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-16">
        ...
        <p className="mt-2 max-w-lg text-sm text-muted-foreground">
          The students behind AW Drone Soccer Leagues System.
        </p>
